...
{
	public class LabExamOper : BasePage
	{
		...
		protected void GetNatUserList(ref VelocityContext vltContext)
		{
			...
			List<PEIS.Model.SYSOpUser> sectionDoctorListByCache = base.GetSectionDoctorListByCache(@int);
			vltContext.Put("UserModelList", sectionDoctorListByCache);
		}

		protected void GetNatSectionModel(ref VelocityContext vltContext, int ID_Section)
		{
			vltContext.Put("SYSSectionModel", PEIS.BLL.SYSOpUser.Instance.GetModelByCache(ID_Section));
		}
	}
}
