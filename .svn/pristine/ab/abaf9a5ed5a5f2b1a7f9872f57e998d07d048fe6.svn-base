...
$(document).ready(function () {
    ...
    jQuery("#slTeamTaskGroup").select2();
    //为团体绑定CLick事件
...
function QueryPagesData(pageIndex) {
    ...
    var ID_TeamTaskGroup = document.getElementById("slTeamTaskGroup").options[document.getElementById("slTeamTaskGroup").selectedIndex].value; //分组ID
