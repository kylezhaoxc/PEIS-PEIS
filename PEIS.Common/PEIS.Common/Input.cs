...
namespace PEIS.Common
{
    public class Input
    {
        private static string[] strChineseList;
        ...
        {
            string str;
            if ((sInput == null ? false : !(sInput.Trim() == string.Empty)))
            {
                string lower = sInput.ToLower();
                string str1 = sInput;
                if (Regex.Match(lower, Regex.Escape("*|and|exec|insert|select|delete|update|count|master|truncate|declare|char(|mid(|chr(|'"), RegexOptions.IgnoreCase | RegexOptions.Compiled).Success)
                {
        ...
        public static string FilterHtmlObject(string html)
        {
            html = Input.loseIframe(html);
            html = Input.loseScript(html);
            html = Input.FilterHTML(html);
            return html;
        }
        ...
        public static string FilterLogHTML(string html)
        {
            ...
            {
                if ((html.ToLower().IndexOf("<img") <= -1 ? false : html.ToLower().IndexOf(">") > -1))
                {
                    html = string.Concat("<span class=\"sp_reshow\">【图文日志】</span>", html);
                }
        ...
        private static string GetCharSpellFirstCode1(string CnChar)
        {
            string upper;
            byte[] bytes = Encoding.Default.GetBytes(CnChar);
            if ((int)bytes.Length != 1)
            {
                int num = bytes[0];
                long num1 = (long)(num * 256 + bytes[1]);
                if (!(num1 < (long)45217 ? true : num1 > (long)45252))
                {
                    upper = "A";
                }
                else if (!(num1 < (long)45253 ? true : num1 > (long)45760))
                {
                    upper = "B";
                }
                else if (!(num1 < (long)45761 ? true : num1 > (long)46317))
                {
                    upper = "C";
                }
                else if (!(num1 < (long)46318 ? true : num1 > (long)46825))
                {
                    upper = "D";
                }
                else if (!(num1 < (long)46826 ? true : num1 > (long)47009))
                {
                    upper = "E";
                }
                else if (!(num1 < (long)47010 ? true : num1 > (long)47296))
                {
                    upper = "F";
                }
                else if (!(num1 < (long)47297 ? true : num1 > (long)47613))
                {
                    upper = "G";
                }
                else if (!(num1 < (long)47614 ? true : num1 > (long)48118))
                {
                    upper = "H";
                }
                else if (!(num1 < (long)48119 ? true : num1 > (long)49061))
                {
                    upper = "J";
                }
                else if (!(num1 < (long)49062 ? true : num1 > (long)49323))
                {
                    upper = "K";
                }
                else if (!(num1 < (long)49324 ? true : num1 > (long)49895))
                {
                    upper = "L";
                }
                else if (!(num1 < (long)49896 ? true : num1 > (long)50370))
                {
                    upper = "M";
                }
                else if (!(num1 < (long)50371 ? true : num1 > (long)50613))
                {
                    upper = "N";
                }
                else if (!(num1 < (long)50614 ? true : num1 > (long)50621))
                {
                    upper = "O";
                }
                else if (!(num1 < (long)50622 ? true : num1 > (long)50905))
                {
                    upper = "P";
                }
                else if (!(num1 < (long)50906 ? true : num1 > (long)51386))
                {
                    upper = "Q";
                }
                else if (!(num1 < (long)51387 ? true : num1 > (long)51445))
                {
                    upper = "R";
                }
                else if (!(num1 < (long)51446 ? true : num1 > (long)52217))
                {
                    upper = "S";
                }
                else if (!(num1 < (long)52218 ? true : num1 > (long)52697))
                {
                    upper = "T";
                }
                else if (!(num1 < (long)52698 ? true : num1 > (long)52979))
                {
                    upper = "W";
                }
                else if (!(num1 < (long)52980 ? true : num1 > (long)53640))
                {
                    upper = "X";
                }
                else if (!(num1 < (long)53689 ? true : num1 > (long)54480))
                {
                    upper = "Y";
                }
                else if ((num1 < (long)54481 ? true : num1 > (long)55289))
                {
                    ...
                    int num2 = (Convert.ToInt16(str1.Substring(0, 2)) - 56) * 94 + Convert.ToInt16(str1.Substring(str1.Length - 2, 2));
                    upper = (num2 < 1 ? "" : str.Substring(num2 - 1, 1));
                }
                else
                {
                    upper = "Z";
            ...
            {
                upper = CnChar.ToUpper();
            }
            return upper;
        }

        private static string GetCharSpellFirstCode2(string CnChar)
        {
            string str;
            if (CnChar.CompareTo("吖") < 0)
            {
                string upper = CnChar.Substring(0, 1).ToUpper();
                str = (!char.IsNumber(upper, 0) ? upper : upper);
            }
            ...
            else if (CnChar.CompareTo("币") >= 0)
            {
                str = (CnChar.CompareTo("咗") >= 0 ? "" : "Z");
            }
            else
            {
                str = "Y";
        ...
        public static string GetFirstAlphabet(string strCharacter)
        {
            if ((strCharacter == null) || (strCharacter.Length == 0))
            {
                return strCharacter;
            }
            string str = "";
            char[] chArray = strCharacter.ToCharArray();
            foreach (char ch in chArray)
            {
                if ((((ch >= 'a') && (ch <= 'z')) || ((ch >= 'A') && (ch <= 'Z'))) || ((ch >= '0') && (ch <= '9')))
                {
                    str = (str + Convert.ToString(ch)).ToUpper();
                }
                else if ((ch >= '一') && (ch <= 0x9fa5))
                {
                    for (int i = 0; i < strChineseList.Length; i++)
                    {
                        string str2 = strChineseList[i];
        ...
        public static string GetStringSpellCode(string CnStr)
        {
            string str = "";
            CnStr = Input.GetFirstAlphabet(CnStr);
            int length = CnStr.Length;
            int i = 0;
            string charSpellFirstCode1 = "";
            for (i = 0; i <= length - 1; i++)
            {
                charSpellFirstCode1 = Input.GetCharSpellFirstCode1(CnStr.Substring(i, 1));
                if (charSpellFirstCode1 == "")
                {
                    charSpellFirstCode1 = Input.GetCharSpellFirstCode2(CnStr.Substring(i, 1));
                }
                charSpellFirstCode1 = Input.ReplaceSpecialCharacter(charSpellFirstCode1);
                str = string.Concat(str, charSpellFirstCode1);
            }
            return str;
        }
        ...
        public static string GetSubString(string Str, int Num)
        {
            ...
            if ((Str == null ? false : !(Str == "")))
            {
                ...
                {
                    char chr = str1[num];
                    byteCount = byteCount + Encoding.Default.GetByteCount(chr.ToString());
                    if (byteCount <= Num)
                    {
                        empty1 = string.Concat(empty1, chr);
                        num++;
                    }
                    else
                    {
                ...
                empty = (Str.Length <= 2 ? empty1 : string.Concat(empty1, str));
            }
            else
            {
                empty = string.Empty;
        ...
        public static string GetSubString(string Str, int Num, out int Len)
        {
            ...
            if (!string.IsNullOrEmpty(Str))
            {
                ...
                {
                    char chr = str1[num];
                    Len = Len + Encoding.Default.GetByteCount(chr.ToString());
                    if (Len <= Num)
                    {
        ...
        {
            return (Str.Length > Num ? string.Concat(Str.Substring(0, Num), LastStr) : Str);
        }

        public static string HtmlDecode(string Input)
        {
            string str;
            str = (!string.IsNullOrEmpty(Input) ? HttpContext.Current.Server.HtmlDecode(Input) : string.Empty);
            return str;
        }
        ...
        public static string Htmls(string Input)
        {
            ...
            {
                string str = Input.ToLower().Replace("<script", "&lt;script");
        ...
        {
            bool flag;
            flag = (!string.IsNullOrEmpty(strIn) ? Regex.IsMatch(strIn, "^([a-zA-Z0-9_\\-\\.]+)@((\\[[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.)|(([a-zA-Z0-9\\-]+\\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\\]?)$") : false);
            return flag;
        }
        ...
        {
            bool flag;
            flag = (Input != null ? Common.Input.IsInteger(Input, true) : false);
            return flag;
        }
        ...
        public static bool IsInteger(object Input, bool Plus)
        {
            ...
            else if (!string.IsNullOrEmpty(Input.ToString()))
            {
                ...
                flag = (!Regex.Match(Input.ToString(), str, RegexOptions.Compiled).Success ? false : true);
            }
            else
            {
                flag = false;
        ...
        public static bool isMobile(string strIn)
        {
            ...
            {
                flag = (!Regex.Match(strIn, "^13[0-9]{9}|15[012356789][0-9]{8}|18[0256789][0-9]{8}|147[0-9]{8}$", RegexOptions.Compiled).Success ? false : true);
            }
            else
            {
                flag = false;
        ...
        public static bool isTel(string strIn)
        {
            ...
            if (!string.IsNullOrEmpty(strIn))
            {
                flag = (!Regex.Match(strIn, "\\d{3,4}-\\d{7,8}(-\\d+){0,1}", RegexOptions.Compiled).Success ? false : true);
            }
            else
            {
                flag = false;
        ...
        public static string loseExceptImg(string html)
        {
            ...
            if (!string.IsNullOrEmpty(html))
            {
                html = (new Regex("<(?!/?img)[\\s\\S]*?>", RegexOptions.IgnoreCase)).Replace(html, "");
                empty = html;
            }
            else
            {
        ...
        public static string loseIframe(string html)
        {
            ...
            if (!string.IsNullOrEmpty(html))
            {
                Regex regex = new Regex("<iframe[\\s\\S]+</iframe\\s*>", RegexOptions.IgnoreCase);
                Regex regex1 = new Regex("<frameset[\\s\\S]+</frameset\\s*>", RegexOptions.IgnoreCase);
        ...
        public static string loseScript(string html)
        {
            ...
            if (!string.IsNullOrEmpty(html))
            {
                html = (new Regex("<script[\\s\\S]+</script\\s*>", RegexOptions.IgnoreCase)).Replace(html, "");
                empty = html;
            }
            else
            {
        ...
        public static string loseSqlScript(string html)
        {
            string empty;
            if (!string.IsNullOrEmpty(html))
            {
                string[] strArrays = "exec|select|drop|alter|exists|union|xor|order|execute|xp_cmdshell|insert|update|delete|join|declare|sp_oacreate|wscript.shell|xp_regwrite|char(|mid(|chr(".Split(new char[] { '|' });
                for (int i = 0; i < (int)strArrays.Length; i++)
                {
                    html = html.Replace(strArrays[i], "*");
                }
                empty = html;
            }
            else
        ...
        private static string ReplaceSpecialCharacter(string CnChar)
        {
            string cnChar;
            if (!string.IsNullOrEmpty(CnChar))
            {
                ...
                {
                    CnChar = CnChar.Replace(strArrays1[num], "");
                    if (!string.IsNullOrEmpty(CnChar))
                    {
                        num++;
                    }
        ...
        public static void splitImgAndText(string html, out string img, out string text)
        {
            if (html != null)
            {
                Match match = (new Regex("<img[\\s\\S]+</img *>|<img[^>]+/? *>", RegexOptions.IgnoreCase)).Match(html);
                string empty = string.Empty;
                while (match.Success)
                {
                    empty = string.Concat(empty, match.Value);
                    match = match.NextMatch();
                }
                string str = Input.FilterHTML(html);
                img = empty;
                text = str;
            }
            else
        ...
        public static DataSet ToHtml(DataSet ds)
        {
            for (int i = 0; i < ds.Tables.Count; i++)
            {
                foreach (DataColumn column in ds.Tables[i].Columns)
                {
                    if ((column.DataType.FullName.ToLower() == "system.string" ? true : column.DataType.FullName.ToLower() == "system.object"))
                    {
                        DataRow[] dataRowArray = ds.Tables[i].Select();
                        if ((dataRowArray == null ? false : (int)dataRowArray.Length > 0))
                        {
                            for (int j = 0; j < (int)dataRowArray.Length; j++)
                            {
                                dataRowArray[j][column.ColumnName] = dataRowArray[j][column.ColumnName].ToString().Replace("&", "&amp;").Replace("<", "&lt;").Replace(">", "&gt;").Replace("\r\n", "<br />").Replace("\n", "<br />").Replace("\t", " ");
                            }
                        }
                    }
                }
        ...
        public static DataTable ToHtml(DataTable dt)
        {
            foreach (DataColumn column in dt.Columns)
            {
                ...
                if ((dataRowArray == null ? false : (int)dataRowArray.Length > 0))
                {
                    ...
                    {
                        dataRowArray[i][column.ColumnName] = dataRowArray[i][column.ColumnName].ToString().Replace("&", "&amp;").Replace("<", "&lt;").Replace(">", "&gt;").Replace("\r\n", "<br />").Replace("\n", "<br />").Replace("\t", " ");
                    }
                }
            }
            return dt;
        ...
        public static string ToShowSqlTxt(string Input)
        {
        ...
        public static string URLDecode(string Input)
        {
            ...
            {
                string str = HttpContext.Current.Server.UrlDecode(Input);
                empty = Common.Input.FilterHtmlObject(str);
            }
            return empty;
        }
        ...
        {
            string str;
            str = (!string.IsNullOrEmpty(Input) ? HttpContext.Current.Server.UrlEncode(Input) : string.Empty);
            return str;
        }
    }
}
