			...
			if (custRelationCustPEInfo != null && 0 < custRelationCustPEInfo.Tables[0].Rows.Count)
			{
				...
				if (list != null)
				{
					...
					if (onCustPhysicalExamInfo != null)
					{
						...
						vltContext.Put("FinalOverView", onCustPhysicalExamInfo.FinalOverView);
						vltContext.Put("FinalConclusion", onCustPhysicalExamInfo.FinalConclusion);
						vltContext.Put("ResultCompare", onCustPhysicalExamInfo.ResultCompare);
						vltContext.Put("MainDiagnose", onCustPhysicalExamInfo.MainDiagnose);
						vltContext.Put("SecondaryDiagnose", onCustPhysicalExamInfo.SecondaryDiagnose);
						vltContext.Put("IndicatorDiagnose", onCustPhysicalExamInfo.IndicatorDiagnose);
						vltContext.Put("NormalDiagnose", onCustPhysicalExamInfo.NormalDiagnose);
						vltContext.Put("OtherDiagnose", onCustPhysicalExamInfo.OtherDiagnose);
						vltContext.Put("FinalDietGuide", onCustPhysicalExamInfo.FinalDietGuide);
						vltContext.Put("FinalSportGuide", onCustPhysicalExamInfo.FinalSportGuide);
						vltContext.Put("FinalHealthKnowlage", onCustPhysicalExamInfo.FinalHealthKnowlage);
						vltContext.Put("htmlFinalOverView", onCustPhysicalExamInfo.FinalOverView.Replace("\n", "<br/>"));
						vltContext.Put("htmlFinalConclusion", onCustPhysicalExamInfo.FinalConclusion.Replace("\n", "<br/>"));
						vltContext.Put("htmlResultCompare", onCustPhysicalExamInfo.ResultCompare.Replace("\n", "<br/>"));
						vltContext.Put("htmlMainDiagnose", onCustPhysicalExamInfo.MainDiagnose.Replace("\n", "<br/>"));
						vltContext.Put("htmlSecondaryDiagnose", onCustPhysicalExamInfo.SecondaryDiagnose.Replace("\n", "<br/>"));
						vltContext.Put("htmlIndicatorDiagnose", onCustPhysicalExamInfo.IndicatorDiagnose.Replace("\n", "<br/>"));
						vltContext.Put("htmlNormalDiagnose", onCustPhysicalExamInfo.NormalDiagnose.Replace("\n", "<br/>"));
						vltContext.Put("htmlOtherDiagnose", onCustPhysicalExamInfo.OtherDiagnose.Replace("\n", "<br/>"));
						vltContext.Put("htmlFinalDietGuide", onCustPhysicalExamInfo.FinalDietGuide.Replace("\n", "<br/>"));
						vltContext.Put("htmlFinalSportGuide", onCustPhysicalExamInfo.FinalSportGuide.Replace("\n", "<br/>"));
						vltContext.Put("htmlFinalHealthKnowlage", onCustPhysicalExamInfo.FinalHealthKnowlage.Replace("\n", "<br/>"));
						if (onCustPhysicalExamInfo.Is_Checked == false)
						{
							string text = this.GetCustomerRefuseReason(ID_Customer);
							text = text.Replace("\n", "<br/>");
							vltContext.Put("RefuseReason", text);
						}
					}
				}
			}
