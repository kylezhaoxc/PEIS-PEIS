			...
			if (custRelationCustPEInfo != null && 0 < custRelationCustPEInfo.Tables[0].Rows.Count)
			{
				...
				if (list != null)
				{
					...
					if (onCustPhysicalExamInfo != null)
					{
						...
						vltContext.Put("textareaResultCompare", onCustPhysicalExamInfo.ResultCompare);
						vltContext.Put("MainDiagnose", onCustPhysicalExamInfo.MainDiagnose.Replace("\n", "<br/>"));
						vltContext.Put("SecondaryDiagnose", onCustPhysicalExamInfo.SecondaryDiagnose.Replace("\n", "<br/>"));
						vltContext.Put("IndicatorDiagnose", onCustPhysicalExamInfo.IndicatorDiagnose.Replace("\n", "<br/>"));
						vltContext.Put("NormalDiagnose", onCustPhysicalExamInfo.NormalDiagnose.Replace("\n", "<br/>"));
						vltContext.Put("OtherDiagnose", onCustPhysicalExamInfo.OtherDiagnose.Replace("\n", "<br/>"));
