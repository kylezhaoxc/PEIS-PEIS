...
function QueryPagesData(pageIndex) {
    ...
    jQuery.ajax({
        ...
        success: function (msg) {
            ...
            var CustomerManageTempLate = jQuery("#CustomerManageTempLate table tbody").html(); //获取模板
            var Content = "";
            ...
            if (Content != "") {
                jQuery("#Pagination").show();
                jQuery("#Searchresult tbody").html(Content);
                SetTableRowStyle();
                ShowCustomerBigPic();
...
function ResetSearchInfo(msgInfo) {
    ...
    jQuery('#Searchresult tbody').html(html); //设置无数据检索时显示提示信息
