...
jQuery(document).ready(function () {
    ...
    IsCommon = document.getElementById("IsCommon") == null ? 0 : document.getElementById("IsCommon").value; //xmhuang 2014-03-18 获取是否共用登记参数
        ...
        success: function (msg) {
            if (parseInt(msg.totalCount) > 0) {
                ...
                jQuery(msg.dataList).each(function (i, item) {
                    ...
                    if (templateContent != null) {
                        ...
                        //.replace(/@Is_Team/gi, item.Is_Team)
                            ...
                            .replace(/@SubScribDate/gi, item.OperateDate)
                ...
                if (newcontent != '') {
                    ...
                    GetCustomerExamListArcPhysicalInfo(tmpCustomerIDsStr); // 查询指定体检号的存档信息及体检基本信息 (查询分页列表的补充信息)
                }
            } else {
                ResetSearchInfo("");
            }
